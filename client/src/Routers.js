...
import Assignment from './components/prof/assignmentComponents/Assignment'
import NewAssignment from './components/prof/assignmentComponents/NewAssignment'
import Assignments from './components/student/assignmentComponents/Assignments'
        ...
        <div className={`whole ${th}`}>
            <Router>
                <Switch>
                    ...
                    <Route path="/prof/Assignment" exact>
                        <Assignment />
                    </Route>
                    <Route path="/prof/NewAssignment" exact>
                        <NewAssignment />
                    </Route>
                    <Route path="/prof/ManageAssignments" exact>
                        <ManageAssignments />
                    </Route>
