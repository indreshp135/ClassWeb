...
const box = [
    { name: "Join Class", icon: faPlus },
    { name: "Time Table", icon: faCalendar },
    { name: "Appoint CR", icon: faUsers },
    { name: "Study Material", icon: faBookReader },
    { name: "Online Class", icon: faChalkboardTeacher },
    { name: "Publish Results", icon: faListAlt },
    { name: "Assignment", icon: faStickyNote }
];
