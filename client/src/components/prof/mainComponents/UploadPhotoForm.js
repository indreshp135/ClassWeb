...
import { addPhoto,showPage } from '../../../redux/prof/photo/photoActions';
...
export const UploadPhotoForm = () => {
  ...
  const photostate =useSelector(state=>state.profphoto);
        ...
        <div className="row h-100 justify-content-center align-items-center">
          <div className="card card-block ">
            <h4 className="card-header">Change profile pic<div  id="close-sidebar" onClick={toggle}>
              ...
              <p>Upload any JPG/JPEG images less than 2MB</p>
