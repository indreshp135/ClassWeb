...
import {faCommentAlt,faCalendar,faPoll,faBookReader,faChalkboardTeacher,faListAlt } from '@fortawesome/free-solid-svg-icons';
import {useHistory} from 'react-router-dom';
import {useSelector} from 'react-redux'
const box = [{name:"Chat", icon:faCommentAlt},{name:"Time Table",icon:faCalendar},{name:"Polls",icon:faPoll},{name:"Study Material",icon:faBookReader},{name:"Online Class",icon:faChalkboardTeacher},{name:"Results",icon:faListAlt}];
