...
import {changeTable } from "../../../redux/student/auth/authActions";
...
export default function TableBox() {
    ...
    const classname = auth.user.classname;
    ...
    const table = auth.class.timetable
    const options = auth.class.subjects
    const elements = options.map((option)=>(<option>{option.coursecode}</option>))
    const changeItem = (e)=>{
    ...
    const submitForm = (e)=>{
        ...
        if(typen==="Free")
            ...
            k=4; 
        console.log(subject)
        dispatch(changeTable(classname,index,subject,k))
    }
    const dark=  (
        <Container fluid>
        <Row>
        ...
        <Row>
            ...
            :
            <Col>
            <Tooltip title="Ask your CR to change or ask any Prof to make you CR">
                <IconButton className="dark2" aria-label="Ask your CR to change or ask any Prof to make you CR">
                    <Button variant="danger" type="submit" className="cursor-disabled" disabled>
                        Edit Table
                    </Button>
                </IconButton>
            </Tooltip>
            ...
            <Col>
                <Form method="post">
                    ...
                    <FormGroup>
                        <Input type="select" name="subject" placeholder="Select" className="dark2 text-white" onChange={changeTypen}>
                            <option>Free</option>
        ...
        <Row>
            ...
            <Col>
                <Form method="post">
                    ...
                    <FormGroup>
                        <Input type="select" name="subject" placeholder="Select" onChange={changeTypen}>
                            <option>Free</option>
                            <option>Regular</option>
                            <option>Special</option>
                            <option>Cancelled</option>
